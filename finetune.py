...
def fine_tune_on_dataset(args, dataset_name, num_epochs, learning_rate, batch_size, weight_decay, log_path):
    ...
    checkpoint_path = os.path.join(
        args.save, f"{dataset_name}_bs{batch_size}_lr{learning_rate}_wd{weight_decay}.pt"
    )
    ...
    save_path = os.path.join(args.save, f"{dataset_name}_bs{batch_size}_lr{learning_rate}_wd{weight_decay}.pt")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_path", type=str, required=True, help="Path to save results log with distinguishable naming")
